...
window.projectVersion = 'v1.3.0';

(function(root) {

    var bhIndex = null;
    var rootPath = '';
    var treeHtml = '        <ul>                <li data-name="namespace:JsonBrowser" class="opened">                    <div style="padding-left:0px" class="hd">                        <span class="glyphicon glyphicon-play"></span><a href="JsonBrowser.html">JsonBrowser</a>                    </div>                    <div class="bd">                                <ul>                <li data-name="class:JsonBrowser_Exception" class="opened">                    <div style="padding-left:26px" class="hd leaf">                        <a href="JsonBrowser/Exception.html">Exception</a>                    </div>                </li>                            <li data-name="class:JsonBrowser_JsonBrowser" class="opened">                    <div style="padding-left:26px" class="hd leaf">                        <a href="JsonBrowser/JsonBrowser.html">JsonBrowser</a>                    </div>                </li>                </ul></div>                </li>                </ul>';
